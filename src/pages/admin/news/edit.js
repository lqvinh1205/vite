                            ...
                            <div class="mt-5">
                                ...
                                <div class="shadow sm:rounded-md sm:overflow-hidden">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                        <input type="text" placeholder="title" value="${result.title}"  class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 p-2 rounded-md">
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                        <textarea id="about" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-3 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="you@example.com">${result.desc}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <span class="overflow-hidden bg-gray-100">
                                            <img class="h-28 w-28 object-fill" src="${result.img}">
                                        </span>
